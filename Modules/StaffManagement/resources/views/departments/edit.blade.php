        ...
        <div class="card-body">
            ...
            <div class="text-end">
             <a href = "{{ route('staff/departments') }}" class="btn btn-primary waves-effect waves-light mb-4 text-end">
              ...
              <form class="form-horizontal" role="form" method = "post" action="{{ route('departments.update') }}">
                            @csrf
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-8">
                                      <input type="text" id="departmentname" name="departmentname" class="form-control" placeholder="Enter the Department name" value = "{{ $department->departmentname }}" required>
