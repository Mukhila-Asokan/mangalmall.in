   <header id="header" class="header-main">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="topbar-text">
                            <ul class="list-inline text-right">
                                <li class="list-inline-item"><a href="<?php echo e(route('login')); ?>"><span class="fas fa-user mr-2"></span> Login</a></li>
                                <li class="list-inline-item"><a href="<?php echo e(route('register')); ?>"><span class="fas fa-lock mr-2"></span> Register</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div id="navBar" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto main-navbar-nav">
                            ...
                            <li class="nav-item hs-has-mega-menu custom-nav-item" data-position="left">
                                <a class="nav-link custom-nav-link" href="<?php echo e(route('home')); ?>" aria-haspopup="true" aria-expanded="false">Home</a>
    ...
    <!--header section end-->
<?php /**PATH C:\xampp\htdocs\mangalmall\resources\views/layouts/menubar.blade.php ENDPATH**/ ?>